...
class UnpackTester:
    ...
    def unpack_bytes(self):
        ...
        #----------------------------------------------------------------
        # Your code goes here
        x = unpack(">16B",self.data[0:16])
        print("Unpacked Bytes:",x)
    ...
    def decode_bytes(self):
        ...
        #----------------------------------------------------------------
        # Your code goes here
        print("Decoded Bytes:",bytes.decode(self.data[0:16]))
    ...
    def join_example(self):
        ...
        #----------------------------------------------------------------
        # Your code goes here
        print("Join Example:",":-)".join(chr_array))
